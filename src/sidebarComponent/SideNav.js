...
const SideNav = () => {
  ...
  return (
    <div>
      ...
      <div id="mySidenav" className="sidenav" style={{background:"#bbbbbb"}} >
      ...
      <div className="row sidemenu-wall ms-2">
            ...
            <div className="col-9 align-self-center wallet-text-side">
                ...
                (
                  (walletId)?(walletId.substring(0, 5)+'.....'+walletId.substring((walletId.length)-5)):(<button onClick={solanaConnect}>Kết nối ví</button>)
                )}
            </div>
          </div>
