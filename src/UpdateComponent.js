 ...
 const [actvAttrib,setActivAttrib] = useState(false);
  ...
  useEffect(() => {
    fetch(nftUrl, {
      ...
      .then((res) => {
        if (!res.ok) {
          throw Error("không thể tìm nạp dữ liệu NFT từ máy chủ");
        }
        return res.json();
      })
      .then((data) => {
  ...
  const callback = (signature,result) => {
    ...
    try {
      ...
      {
        setMainErr("Ký giao dịch không thành công");
        setUpdated(false);
      }
  ...
  const handleUpload = async (e) => {
    ...
    {
      setMainErr("Một số trường không thể để trống");
    }
    else
    {
      setloading(true);
        ...
        <div className="container-lg mint-single">
          <div className="row page-heading-container">
            <div className="col-sm-12 col-md-10">
              <h2 className="section-heading">Cập nhật NFT</h2>
              <p className="p-para text-danger">
              Nhập giá trị của các trường mà bạn muốn cập nhật. Các giá trị trước đó đã được điền trước.
              </p>               
            </div>
                ...
                <div className="form-section">
                  <div className="form-elements-container">
                    ...
                    <div className="white-form-group">
                      ...
                      Mô tả sẽ được đưa vào chi tiết của mặt hàng
                         trang bên dưới hình ảnh của nó.
                      </label>
                      <div className="d-flex justify-content-between">
                        <textarea
                          name="desc"
                    ...
                    <div className="white-form-group">
                      ...
                      <br />
                      <label className="form-label sub-label" htmlFor="name">
                      Các thuộc tính hiển thị bên dưới mục của bạn.
                      </label>
                      <div className="row">
                        <div className="col-8">
