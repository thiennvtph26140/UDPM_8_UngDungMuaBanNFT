...
const Transfer = () => {
  ...
  return (
    <div>
      ...
      {transPop && (
        <TransferLoader
          setTransPop={setTransPop}
          setTransAddr={setTransAddr}
          transAddr={transAddr}
            ...
            <div className="col-12 col-md-8">
              ...
              {transferArr.length > 0 ? (
                <p className="p-para text-success">
                  {transferArr.length} NFT(s) Selected for TRANSFER
                </p>
              ) : (
                <p className="p-para">
                  Chọn NFT bạn muốn chuyển từ ví của mình sang ví của người khác
                </p>
              )}
            </div>
            ...
            <div className="col-12 col-md-2">
              <div className="white-form-group">
                {transferArr.length > 0 ? (
                  ...
                  >
                    Transfer{" "}
                    <span className="badge rounded-pill bg-light text-dark pill-badges">
                      {transferArr.length}
                    </span>
                  </button>
                ) : (
                ...
                {/* // <button className="btn-solid-grad disabled px-5">Chuyển</button>} */}
              </div>
            </div>
          </div>
          {mssg && (
                    ...
                    <div className="inner-box">
                      ...
                      <div className="row pt-3 pb-2">
                        <div className="col-12 col-xl-6">
                          ...
                          >
                            {nft.name.length > 8
                              ? nft.name.substring(0, 8) + "..."
                              : nft.name}
                          </p>
                        </div>

                        <div className="col-12 col-xl-6 pt-1 px-3">
                          {transferArr.includes(nft.mint) ? (
                            <div className="white-button-container-selected">
                              <button
                                onClick={() => {
                                  remFromList(nft.mint);
                                }}
                              >
                                {" "}
                                -{" "}
                            ...
                            <div className="white-button-container-select">
                              <button
                                onClick={() => {
                                  addToList(nft.mint);
                                }}
