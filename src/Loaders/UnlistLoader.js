        ...
        <div>
            <div className="full-overlay">
                <div className="list-square">
                    ...
                    <div>
                        <button className="btn-solid-grad" onClick={() => props.listNFT(props.listingNFT)}>Danh sách</button>
                        <button className="btn-solid-grad" onClick={props.closePopupList}>Hủy</button>
                    </div>
