...
const Create = () => {
  ...
  useEffect(() => {
    if (compleMint === true)
      navigate(
        `/get-details?token_address=${minted}&network=${network}&refresh`
      );
  }, [compleMint]);
  ...
  const handleUpload = (e) => {
    ...
    if (attribs[0] === { id: "5", trait_type: "", value: "" }) {
      setAttribErr(
        "Attributes should have a trait_type and value, it should not be Empty"
      );
    } else {
      let flag = 0;
      attribs.forEach((element) => {
        if (element.trait_type === "") flag = 1;
      });
      if (flag === 1) {
        ...
        <div className="container-lg mint-single">
          <div className="row page-heading-container">
            <div className="col-sm-12 col-md-8">
              <h2 className="section-heading">Tạo NFT chính</h2>
            </div>
          </div>
                  ...
                  <div className="form-elements-container">
                    ...
                    <div className="white-form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (!e.target.value)
                            setNameErr("Trường này không thể để trống");
                          else setNameErr("");
                    ...
                    <div className="white-form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (!e.target.value)
                            setSymErr("Trường này không thể để trống");
                          else setSymErr("");
                          setSymbol(e.target.value);
                        }}
                        className="form-control"
                        placeholder="nhập biểu tượng NFT"
                        required
                      />
                    ...
                    <div className="white-form-group">
                      ...
                      <label className="form-label sub-label" htmlFor="name">
                        Giữ nó ở mức 0 nếu bạn muốn một loại NFT độc nhất.
                      </label>
                      <input
                        type="number"
                        min={1}
                        ...
                        onChange={(e) => {
                          ...
                          if (a < 0 || !a)
                            setErrMaxSup("Giá trị phải là một số lớn hơn 0");
                          else {
                            setErrMaxSup("");
                          }
                        ...
                        className="form-control"
                        placeholder="Nhập giá trị cung cấp tối đa"
                        required
                      />
                    ...
                    <div className="white-form-group">
                      ...
                      <textarea
                        ...
                        onChange={(e) => {
                          if (!e.target.value)
                            setDescErr("Trường này không thể để trống");
                          else setDescErr("");
