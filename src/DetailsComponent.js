...
const GetDetails = () => {
  ...
  useEffect(() => {
    fetch(nftUrl, {
      ...
      .then((res) => {
        if (!res.ok) {
          throw Error("không thể tìm thấy dữ liệu NFT từ máy chủ");
        }
        return res.json();
      })
      .then((data) => {
  ...
  const callback = (signature,result) => {
    ...
    try {
      ...
      else
      {
        ...
        setErrorOcc("Chữ ký không thành công!");
        setSuccess(false);
      }
    } catch (error) {
      console.log(error);
  ...
  const handleBurn = () => {
    ...
    axios({
        ...
        .then(async (res) => {
          ...
          {
            setErrorOcc("Thất bại! Không thể ghi NFT");
          }
                    ...
                    <div className="row">
                        <div className="col-sm-12 col-md-12 col-lg-4">
                            <div className="image-sub-section">
                                ...
                                <div className="text-center">
                                    {
                                        (updAuth === walletId)? 
                                            (<Link className="btn-solid-grad px-5 mx-1 my-1" to={`/update?token_address=${mintAddr}&network=${networkParams[1]}`}>Cập nhật NFT</Link>):
                                            (<a className={"btn-solid-grad disabled px-5 mx-4"} data-bs-toggle="tooltip" title="You do not have update authority for this NFT">Cập nhật NFT</a>
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-8">
                            <div className="text-section px-3">
                                ...
                                <h6 className="p-para-headings">Mô tả</h6>
                                <p className="p-para-light">
                                    {desc}
                                </p>

                                <h6 className="p-para-headings">Biểu tượng</h6>
                                <p className="p-para-light">
                                    {sym}
                                </p>
                                
                                <h6 className="p-para-headings">Chi tiết</h6>
                                <div className="details-table">
                                    <div className="row">
                                        <div className="col-8">Tiền bản quyền</div>
                                        <div className="col-4 text-end">{roy}</div>
                                    </div>
                                    <div className="row">
                                        <div className="col-4">Địa chỉ đúc tiền</div>
                                    ...
                                    <div className="row">
                                        <div className="col-4">Địa chỉ chủ sở hữu</div>
                                ...
                                <h6 className="p-para-headings">Thuộc tính</h6>
                                <div id="attr" className="details-table">
                                    ...
                                    }
                                    {
                                        (attrib.length<1) && (
                                            <div className="row">
                                                <div className="col-12">Không tìm thấy thuộc tính</div>
                                            </div>
                                            )
                                    }
