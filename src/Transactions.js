            ...
            <div className="right-al-container mb-2">
                <div className="container-lg p-4">
                    <div className="transaction-lp mt-4">
                        <h2 className="section-mid-heading mb-4">Danh sách của bạn trên thị trường</h2>
                        <div className="row dark-head-table">
                            <div className="col-12 col-sm-8 content">NFT</div>
                            {/* <div className="col-12 col-sm-5 content"></div> */}
                            <div className="col-12 col-sm-4 content">Giá</div>
                        </div>
                        ...
                        {
                            sellLoaded && ((sells.length === 0)?(<div className="row light-table-body"><div className="col-12 col-sm-12 content">Không tìm thấy lịch sử</div></div>):(<span></span>))
                        }
                        ...
                        <h2 className="section-mid-heading mt-4 mb-4">Lịch sử mua của bạn</h2>
                        <div className="row dark-head-table">
                            <div className="col-12 col-sm-2 content">Price</div>
                            <div className="col-12 col-sm-3 content text-center">Địa chỉ NFT</div>
                            <div className="col-12 col-sm-4 content text-center">Mua từ</div>
                            <div className="col-12 col-sm-3 content text-center">Thời gian</div>
                        </div>
